        ...
        public function frontend_enqueue(){
            ...
            if(lastudio_kit_settings()->is_combine_js_css()){
                ...
                if(!empty($available_widgets)){
                    if( isset( $available_widgets['breadcrumbs'] ) && filter_var( $available_widgets['breadcrumbs'], FILTER_VALIDATE_BOOLEAN ) ){
                        wp_enqueue_style('lakit-breadcrumbs');
                    }
                    if( isset( $available_widgets['search'] ) && filter_var( $available_widgets['search'], FILTER_VALIDATE_BOOLEAN ) ){
                        wp_enqueue_style('lakit-search');
                    }
                    if( isset( $available_widgets['subscribe-form'] ) && filter_var( $available_widgets['subscribe-form'], FILTER_VALIDATE_BOOLEAN ) ){
                        wp_enqueue_style('lakit-subscribe-form');
                        wp_enqueue_script('lakit-subscribe-form');
                    }
                }
			}
        }
