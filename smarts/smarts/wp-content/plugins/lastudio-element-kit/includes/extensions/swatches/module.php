...
?>
    ...
    private function get_product_variation_image_url_by_attribute($product_variations, $attribute_name, $attribute_value ){
        ...
        if($image_id){
            return apply_filters('lastudio-kit/swatches/get_product_variation_image_url_by_attribute', wp_get_attachment_image_url($image_id, apply_filters( 'single_product_archive_thumbnail_size', 'shop_catalog' )), $image_id);
        }
        return $image_url;
    }
