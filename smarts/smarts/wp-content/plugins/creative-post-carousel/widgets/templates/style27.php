<div class="bwdbpc_blogPost_8 bwdbpc_blogPost_list_27 bwdbpc-slider-common <?php echo esc_attr($settings['bwdbpc_dots_type_style']); ?>" id="<?php echo esc_attr( $settings['bwdbpc-blogpost-custom-id'] ); ?>">
        ...
        <div class="col-bwdbpc">
            <div class="bwdbpc_blog_box">
                <?php if('yes' === $bwdbpc_image_swtcher){ /* <div>*/ $this->bwdbpc_post_thumbnail_with_css(); } else{?><div class="bwdbpc_blog_image bwdbpc_image_overly_b bwdbpc_image_overly_a"><?php } ?>
                        ...
                        <div class="bwdbpc_blog_date <?php echo $bwdbpc_cont_align; ?>">
                        <?php echo get_the_date($bwdbpc_blog_date_format); ?>
                        </div>
                        <?php } ?>
                </div>
