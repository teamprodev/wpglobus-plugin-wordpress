<div class="bwdbpc_blogPost_4 bwdbpc_blogPost_list_23 bwdbpc-slider-common <?php echo esc_attr($settings['bwdbpc_dots_type_style']); ?>" id="<?php echo esc_attr( $settings['bwdbpc-blogpost-custom-id'] ); ?>">
            ...
            <div class="bwdbpc_blog_box">
                <?php if('yes' === $bwdbpc_image_swtcher){ /* <div>*/ $this->bwdbpc_post_thumbnail_with_css(); } else{?><div class="bwdbpc_blog_image bwdbpc_image_overly_b bwdbpc_image_overly_a"><?php } ?>
                    <div class="bwdbpc_overlay_icon">
                        <i class="bwdbpc_icons fa-solid fa-plus"></i>
                    </div>
                ...
                <div class="bwdbpc_blog_bottom_part <?php echo $bwdbpc_cont_align; ?>">
                    ...
                    <?php } ?>
                    <div class="bwdbpc_blog_meta bwdbpc_blog_meta1 <?php echo $bwdbpc_cont_align; ?>">
