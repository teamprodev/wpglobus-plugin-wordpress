<div class="bwdbpc_blogPost_9 bwdbpc-slider-common <?php echo esc_attr($settings['bwdbpc_dots_type_style']); ?>" id="<?php echo esc_attr( $settings['bwdbpc-blogpost-custom-id'] ); ?>">
            ...
            <div class="bwdbpc_blog_box">
                ...
                <div class="bwdbpc_blog_bottom_part">
                    <div class="bwdbpc_blog_meta <?php echo $bwdbpc_cont_align; ?>">
                        ...
                        <div class="bwdbpc_blog_user bwdbp-btm-gap bwdbpc-all-meta">
                        <?php if('icon' === $bwdbpc_author_indicator){ ?>
                            <i class="bwdbpc_icons <?php echo $settings['bwdbpc_author_icon']['value']; ?>"></i>
                        <?php } elseif('gravatar' === $bwdbpc_author_indicator){echo get_avatar( get_the_author_meta( 'ID' ), $size = '50', $default = '', $alt = '', $args = array( 'class' => 'wt-author-img' ) );} ?>
                            <?php echo get_the_author_meta( 'nickname' ); ?>
                        </div>
                        <?php }
                        if($bwdbpc_yes_value === $bwdbpc_date_swtcher){ ?>
                        <div class="bwdbpc_blog_date bwdbp-btm-gap bwdbpc-all-meta"><?php if('show' === $bwdbpc_taxo_icon){ ?><i class="bwdbpc_icons far fa-calendar-alt"></i><?php } echo get_the_date($bwdbpc_blog_date_format); ?></div>
                        <?php }
                        if($bwdbpc_yes_value === $bwdbpc_comments_swtcher){ ?>
                        <div class="bwdbpc_blog_comment bwdbp-btm-gap bwdbpc-all-meta">
