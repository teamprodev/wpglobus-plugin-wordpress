<div class="bwdbpc_blogPost_5 bwdbpc-slider-common <?php echo esc_attr($settings['bwdbpc_dots_type_style']); ?>" id="<?php echo esc_attr( $settings['bwdbpc-blogpost-custom-id'] ); ?>">
    ...
    if($wp_query->have_posts()) :
        ...
        <div class="col-bwdbpc">
            <div class="bwdbpc_blog_box bwdbpc_box_padding_cmn bwdbpc_box_style_cmn">
                <div class="bwdbpc_blog_image bwdbpc_image_overly_b bwdbpc_image_overly_a">
