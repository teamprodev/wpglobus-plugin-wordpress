<div class="bwdbpc_blogPost_11 bwdbpc-slider-common <?php echo esc_attr($settings['bwdbpc_dots_type_style']); ?>" id="<?php echo esc_attr( $settings['bwdbpc-blogpost-custom-id'] ); ?>">
    ...
    if($wp_query->have_posts()) :
        ...
        <div class="col-bwdbpc">
            <div class="bwdbpc_blog_box bwdbpc_box_padding_cmn bwdbpc_box_sha bwdbpc_n_bg bwdbpc_box_radi">
                <div class="bwdbpc_blog_image">
                    ...
                    <div class="bwdbpc_blog_date bwdbpc-all-meta">
                        <div class="bwdbpc_date_number"><?php echo get_the_date('j'); ?></div>
                        <div class="bwdbpc_date_month"><?php echo get_the_date('M'); ?></div>
                    </div>
                    <?php } ?>
                </div>
                <div class="bwdbpc_blog_bottom_part bwdbpc_box_radi bwdbpc_g_bg">
