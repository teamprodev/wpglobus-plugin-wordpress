<div class="bwdbpc_blogPost_4 bwdbpc-slider-common <?php echo esc_attr($settings['bwdbpc_dots_type_style']); ?>" id="<?php echo esc_attr( $settings['bwdbpc-blogpost-custom-id'] ); ?>">
    ...
    if($wp_query->have_posts()) :
        ...
        <div class="col-bwdbpc">
            <div class="bwdbpc_blog_box bwdbpc_box_padding_cmn bwdbpc_n_bg bwdbpc_box_radi">
                ...
                <div class="bwdbpc_blog_bottom_part bwdbpc_g_bg bwdbpc_box_sha <?php echo $bwdbpc_cont_align; ?>">
                    <?php
