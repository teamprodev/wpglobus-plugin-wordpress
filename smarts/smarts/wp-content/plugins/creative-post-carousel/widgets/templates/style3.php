<div class="bwdbpc_blogPost_3 bwdbpc-slider-common <?php echo esc_attr($settings['bwdbpc_dots_type_style']); ?>" id="<?php echo esc_attr( $settings['bwdbpc-blogpost-custom-id'] ); ?>">
    ...
    if($wp_query->have_posts()) :
        ...
        <div class="col-bwdbpc">
            ...
            <?php if('yes' === $bwdbpc_image_swtcher){ /* <div>*/ $this->bwdbpc_post_thumbnail_with_css(); } else{?><div class="bwdbpc_blog_image bwdbpc_image_overly_b bwdbpc_image_overly_a"><?php } ?>
                    <div class="bwdbpc_blog_bottom_part">
                        <div class="bwdbpc_blog_meta <?php echo $bwdbpc_cont_align; ?>">
                            ...
                            if($bwdbpc_yes_value === $bwdbpc_date_swtcher){ ?>
                                <div class="bwdbpc_blog_date bwdbp-btm-gap bwdbpc-all-meta">
                            ...
                            <div class="bwdbpc_author-img bwdbp-btm-gap bwdbpc-all-meta">
                            ...
                            if($bwdbpc_yes_value === $bwdbpc_tags_swtcher){ ?>
                                <div class="bedbp_the_tags bwdbp-btm-gap bwdbpc-all-meta">
