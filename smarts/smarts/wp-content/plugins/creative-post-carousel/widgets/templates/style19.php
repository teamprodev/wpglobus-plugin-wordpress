<div class="bwdbpc_blogPost_19 bwdbpc-slider-common <?php echo esc_attr($settings['bwdbpc_dots_type_style']); ?>" id="<?php echo esc_attr( $settings['bwdbpc-blogpost-custom-id'] ); ?>">
        ...
        <div class="col-bwdbpc">
            <div class="bwdbpc_blog_box">
                ...
                <div class="bwdbpc_blog_bottom_part <?php echo $bwdbpc_cont_align; ?>">
                    ...
                    <?php } ?>
                    <div class="bwdbpc_author_info <?php echo $bwdbpc_cont_align; ?>">
                        ...
                        <div class="bwdbpc_blog_user">
                            <?php if($bwdbpc_yes_value === $bwdbpc_author_swtcher){ echo get_the_author_meta( 'nickname' ); } ?>
                        </div>
                    </div>
                    <div class="bwdbpc_blog_meta <?php echo $bwdbpc_cont_align; ?>">
                        ...
                        <div class="bwdbpc_blog_comment bwdbpc-all-meta">
                            <?php if('show' === $bwdbpc_taxo_icon){ ?><i class="bwdbpc_icons fa fa-comments"></i><?php } if(!have_comments()){ echo esc_html__('Comment (', 'bwd-blog-post') . get_comments_number().')'; } ?>
                        </div><?php }
