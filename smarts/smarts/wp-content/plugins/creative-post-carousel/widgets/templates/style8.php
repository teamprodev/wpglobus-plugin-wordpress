<div class="bwdbpc_blogPost_8 bwdbpc-slider-common <?php echo esc_attr($settings['bwdbpc_dots_type_style']); ?>" id="<?php echo esc_attr( $settings['bwdbpc-blogpost-custom-id'] ); ?>">
    ...
    if($wp_query->have_posts()) :
        ...
        <div class="col-bwdbpc">
            <div class="bwdbpc_blog_box bwdbpc_box_padding_cmn bwdbpc_box_sha bwdbpc_box_radi">
                <div class="bwdbpc_blog_image bwdbpc_image_overly_b">
                    <?php if('yes' === $bwdbpc_image_swtcher){ $this->bwdbpc_post_thumbnail_here(); } ?>
                    <?php
                    if($bwdbpc_yes_value === $bwdbpc_date_swtcher){ ?>
                    <div class="bwdbpc_blog_date bwdbpc-all-meta"><?php echo get_the_date($bwdbpc_blog_date_format); ?></div>
                    <?php } ?>
                </div>
                <div class="bwdbpc_blog_bottom_part bwdbpc_g_bg bwdbpc_n_bg_b">
