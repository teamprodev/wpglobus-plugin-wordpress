<div class="bwdbpc_blogPost_1 bwdbpc_blogPost_2 bwdbpc_blogPost_list_21 bwdbpc-slider-common <?php echo esc_attr($settings['bwdbpc_dots_type_style']); ?>" id="<?php echo esc_attr( $settings['bwdbpc-blogpost-custom-id'] ); ?>">
            ...
            <div class="bwdbpc_blog_box">
                ...
                <div class="bwdbpc_blog_bottom_part">
                    <div class="bwdbpc_blog_meta <?php echo $bwdbpc_cont_align; ?>">
                        ...
                        <div class="bwdbpc_category bwdbpc-all-meta-extra1"> 
                        ...
                        ?><div class="bwdbpc_category bwdbpc-all-meta-extra1"> <?php the_category(); ?></div> <?php
                            } 
                        } ?>
                    </div>
