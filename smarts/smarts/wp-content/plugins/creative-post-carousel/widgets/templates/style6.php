<div class="bwdbpc_blogPost_6 bwdbpc-slider-common <?php echo esc_attr($settings['bwdbpc_dots_type_style']); ?>" id="<?php echo esc_attr( $settings['bwdbpc-blogpost-custom-id'] ); ?>">
    ...
    if($wp_query->have_posts()) :
        ...
        <div class="col-bwdbpc">
            <div class="bwdbpc_blog_box bwdbpc_box_padding_cmn bwdbpc_box_sha bwdbpc_box_radi">
                <?php if('yes' === $bwdbpc_image_swtcher){ ?>
                <div class="bwdbpc_blog_image">
                    <?php $this->bwdbpc_post_thumbnail_here(); ?>
                </div>
                <?php } ?>
                <div class="bwdbpc_blog_bottom_part bwdbpc_n_bg">
                    <?php
                ...
                <div class="bwdbpc_overlay_content bwdbpc_g_bg">
