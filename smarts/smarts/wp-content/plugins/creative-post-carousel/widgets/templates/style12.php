<div class="bwdbpc_blogPost_12 bwdbpc-slider-common <?php echo esc_attr($settings['bwdbpc_dots_type_style']); ?>" id="<?php echo esc_attr( $settings['bwdbpc-blogpost-custom-id'] ); ?>">
    ...
    if($wp_query->have_posts()) :
        ...
        <div class="col-bwdbpc bwdbpc_box_margin_cmn">
            <div class="bwdbpc_blog_box bwdbpc_box_padding_cmn bwdbpc_box_style_cmn">
                <div class="bwdbpc_blog_image <?php echo $bwdbpc_cont_align; ?>">
                        <?php if('yes' === $bwdbpc_image_swtcher){ $this->bwdbpc_post_thumbnail_here(); }
                    if($bwdbpc_yes_value === $bwdbpc_categories_swtcher){ ?>
                    <div class="bwdbpc_category_option">
                ...
                <div class="bwdbpc_blog_bottom_part">
                    <div class="bwdbpc_blog_meta <?php echo $bwdbpc_cont_align; ?>">
                        ...
                        <div class="bwdbpc_blog_date bwdbpc-all-meta"><?php if('show' === $bwdbpc_taxo_icon){ ?><i class="bwdbpc_icons far fa-calendar-alt"></i><?php } echo get_the_date($bwdbpc_blog_date_format); ?></div>
                        <?php
                        }
                        if($bwdbpc_yes_value === $bwdbpc_tags_swtcher){ ?>
                        <div class="bedbp_the_tags bwdbpc-all-meta">
