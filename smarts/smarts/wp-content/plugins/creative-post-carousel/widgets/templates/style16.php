<div class="bwdbpc_blogPost_16 bwdbpc-slider-common <?php echo esc_attr($settings['bwdbpc_dots_type_style']); ?>" id="<?php echo esc_attr( $settings['bwdbpc-blogpost-custom-id'] ); ?>">
    ...
    if($wp_query->have_posts()) :
        ...
        <div class="col-bwdbpc">
            <div class="bwdbpc_blog_box bwdbpc_box_padding_cmn bwdbpc_g_bg bwdbpc_box_sha bwdbpc_box_radi">
                <div class="bwdbpc_blog_image">
                    <?php if('yes' === $bwdbpc_image_swtcher){ $this->bwdbpc_post_thumbnail_here(); } ?>
                    <div class="bwdbpc_blog_meta bwdbpc_box_radi bwdbpc_n_bg <?php echo $bwdbpc_cont_align; ?>">
                        <?php if($bwdbpc_yes_value === $bwdbpc_author_swtcher){ ?>
                            <div class="bwdbpc_author-img bwdbp-btm-gap">
                        ...
                        <div class="bwdbpc_blog_comment bwdbpc-all-meta bwdbp-btm-gap">
                        ...
                        <div class="bwdbpc_blog_date bwdbpc-all-meta bwdbp-btm-gap">
                ...
                <div class="bwdbpc_blog_bottom_part <?php echo $bwdbpc_cont_align; ?>">
                    <?php
                    if($bwdbpc_yes_value === $bwdbpc_title_swtcher){
                        ?>
                    <div class="bwdbpc_blog_title">
