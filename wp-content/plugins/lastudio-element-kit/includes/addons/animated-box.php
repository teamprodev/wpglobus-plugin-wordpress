    ...
    protected function register_controls() {
        ...
        $this->_add_control(
            ...
            array(
                ...
                'default' => 'lakit-effect-1',
                'options' => array(
                    'lakit-effect-1'  => esc_html__( 'Flip Horizontal', 'lastudio-kit' ),
                    'lakit-effect-2'  => esc_html__( 'Flip Vertical', 'lastudio-kit' ),
                    'lakit-effect-3'  => esc_html__( 'Fall Up', 'lastudio-kit' ),
                    'lakit-effect-4'  => esc_html__( 'Fall Right', 'lastudio-kit' ),
                    'lakit-effect-5'  => esc_html__( 'Slide Down', 'lastudio-kit' ),
                    'lakit-effect-6'  => esc_html__( 'Slide Right', 'lastudio-kit' ),
                    'lakit-effect-7'  => esc_html__( 'Flip Horizontal 3D', 'lastudio-kit' ),
                    'lakit-effect-8'  => esc_html__( 'Flip Vertical 3D', 'lastudio-kit' ),
                ),
            )
        );
